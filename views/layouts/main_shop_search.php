                ...
                <div class="serar-cart-icon">
                    ...
                    <ul>
                        ...
                        echo '<li><a href="#!" class="search-opt" title="Поиск"><i class="fa fa-search"></i></a></li>
                                  <li><a href="/services" title="Услуги"><i class="fa fa-heartbeat" aria-hidden="true"></i></a></li>
            ...
            <div class="col-12 tel">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">  <a href="/shop/category/<?= $this->params['id']; ?>"> <?= Html::encode($this->title) ?>  </a></li>
                    </ol>
                    <center><address><h3><span>+7(983) 344-76-51</span></h3> </address></center>
                </nav>
        ...
        <div class="row">
            <div class="col-lg-6 col-lg-push-3 col-md-8 col-md-push-3 col-sm-12">
                <div class="search-box">
                    <form  method="get" action="<?= Url::to(['rose/search'])?>">
                        <input type="text" placeholder="искать..." name="q">
                    </form>
                </div>
            </div>
        </div>
