            ...
            <div class="col-lg-8">
                <?php if (!empty($single_blog)): ?>
                    <div class="single-blog-post">
                        <div class="sBD--text">
                            <img src="/images/blog/<?= $single_blog->s_img_bg ?>" alt="">
                            <h2><?= $single_blog->s_name ?></h2>
                            <ul class="blog-meta-data">
                                <li><a href="#"><i class="fa fa-user"></i>От <?= $single_blog->write_by ?></a></li>
                                <li><a href="#"><i
                                                class="fa fa-calendar"></i><?= Yii::$app->formatter->asDate($single_blog->created_at, 'long') ?>
                                    </a></li>
                                <li><a href="#"><i class="fa fa-comment"></i><?= $single_blog->section ?></a></li>
                            </ul>
                            <p><?= $single_blog->s_description ?></p>
                ...
                <div class="sibeader--layout">
                   <!-- <div class="single--sidaber">
                    ...
                    <div class="sibeader--layout">
                        ...
                        <div class="single--sidaber">
                            <h3 class="sidebar--titile">популярные теги</h3>
