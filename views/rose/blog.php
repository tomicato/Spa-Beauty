            ...
            <div class="col-lg-8">
                ...
                <div class="single__blog blog-grid list-view animation" data-animation="fadeInUp" data-animation-delay="0.1s">
                    <div class="blog-thumb">
                        <a href="/blog-single/<?= $item['id']?>"><img src="/images/blog/<?= $item['s_img_sm']?>" alt="<?= $item['s_name']?>" class="img-responsive"></a>
                    </div>
                    <!-- end blog thumb -->
                    <div class="blog-text">
                        <h2><a href="/blog-single/<?= $item['id']?>"><?= $item['s_name']?></a> </h2>
                        <ul class="blog-meta-data">
                            <li><a href="#!"><i class="fa fa-user"></i>От <?= $item['write_by']?></a></li>
                        ...
                        <p><?= $item['s_caption']?></p>
                        <a href="/blog-single/<?= $item['id']?>" class="new-read--more">Подробно</a>
